...
class Request(object):
    ...
    @contextmanager
    def handle_exceptions(self, allow_notification_responses=True):
        ...
        try:
            ...
            if self.is_notification and not config.notification_errors:
                ...
                self.response = ExceptionResponse(exc, getattr(self, 'request_id', None))
        return True
    ...
    def call(self, methods):
        ...
        assert type(self.response) in (ExceptionResponse, NotificationResponse,
