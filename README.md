> :warning: Note: This master branch is for development of the upcoming version 5, which is [currently in alpha](https://github.com/bcb/jsonrpcserver/discussions/204).  
